...
<div class="col-xs-12">
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Template Data Table</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                            ...
                            <tr role="row" class="">
                                ...
                                <td style="text-align: center"><a href={{url("templates/". $template->id ."/edit") }}><button type="button" class="btn btn-warning">Edit</button></a></td>
                                <td style="text-align: center"><a href={{url("templates/". $template->id ."/delete") }}><button type="button" class="btn btn-danger">Delete</button></a></td>
